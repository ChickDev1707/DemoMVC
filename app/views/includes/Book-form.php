<div class="extended-info-form-container">
    ...
    <button class="book-delete-btn" onclick="showDeleteElementMessageBox('warning', 'Bạn có chắc muốn xóa toàn bộ thông tin liên quan đến sách này không?')">Xóa sách</button>
</div>
